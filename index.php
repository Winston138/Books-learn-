    ...
    <div class="title">
        <?$APPLICATION->IncludeComponent(
            ...
            Array(
                ...
                "EDIT_TEMPLATE" => "",
                "PATH" => "/include/inc_title_tovar.php"
            )
        );?>
    </div>
            ...
            <div class="title">
                <?$APPLICATION->IncludeComponent(
                    ...
                    Array(
                        ...
                        "AREA_FILE_SUFFIX" => "inc",
                        "EDIT_TEMPLATE" => "",
                        "PATH" => "/include/inc_title_preim.php"
                    )
                );?>
            </div>
            ...
            <div class="h2">
                <?$APPLICATION->IncludeComponent(
                    ...
                    Array(
                        ...
                        "AREA_FILE_SUFFIX" => "inc",
                        "EDIT_TEMPLATE" => "",
                        "PATH" => "/include/inc_about_title.php"
                    )
                );?>
            </div>
            <?$APPLICATION->IncludeComponent(
                ...
                Array(
                    ...
                    "AREA_FILE_SUFFIX" => "inc",
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/include/inc_about_titletext.php"
                )
            );?>
            <a class="blue_bt" href="">
                <?$APPLICATION->IncludeComponent(
                    ...
                    Array(
                        ...
                        "AREA_FILE_SUFFIX" => "inc",
                        "EDIT_TEMPLATE" => "",
                        "PATH" => "/include/inc_about_textbtn.php"
                    )
                );?>
            </a>
        </div>
                ...
                <div class="title">
                    <?$APPLICATION->IncludeComponent(
                        ...
                        Array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/include/inc_title_news.php"
                        )
                    );?>
                </div>
                <div class="news_list">
